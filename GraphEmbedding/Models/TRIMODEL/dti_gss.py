...
example_facts = np.array([
    [dataset.ent_mappings["P61026"],  dataset.rel_mappings["INTERACT_WITH"], dataset.ent_mappings["Q9H0K6"]],
    [dataset.ent_mappings["DB00008"], dataset.rel_mappings["DRUG_TARGET"], dataset.ent_mappings["Q9H0K6"]]
])
